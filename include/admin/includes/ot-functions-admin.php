          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', esc_html__( 'Pakistan Info Settings', 'wikilogy' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', esc_html__( 'Theme Settings', 'wikilogy' ) ),
                ...
                'position'        => apply_filters( 'ot_theme_options_position', 1 ),
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', esc_html__( 'Theme Options updated.', 'wikilogy' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', esc_html__( 'Theme Options reset.', 'wikilogy' ) ),
                'button_text'     => apply_filters( 'ot_theme_options_button_text', esc_html__( 'Save Changes', 'wikilogy' ) ),
  ...
  function ot_register_settings_page() {
    ...
    if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) || has_action( 'init', 'custom_theme_options' ) ) ) {
      ...
      function ot_has_custom_theme_options() {
        ...
        echo '<div class="error"><p>' . esc_html__( 'The Theme Options UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'wikilogy' ) . '</p></div>';
    ...
    $ot_register_pages_array =  array( 
      array( 
        'id'              => 'ot',
        'page_title'      => esc_html__( 'OptionTree', 'wikilogy' ),
        'menu_title'      => esc_html__( 'OptionTree', 'wikilogy' ),
      ...
      array(
        ...
        'page_title'      => esc_html__( 'Settings', 'wikilogy' ),
        'menu_title'      => esc_html__( 'Settings', 'wikilogy' ),
        'capability'      => 'edit_theme_options',
        'menu_slug'       => 'ot-settings',
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => esc_html__( 'Theme Options updated.', 'wikilogy' ),
        'reset_message'   => esc_html__( 'Theme Options reset.', 'wikilogy' ),
        'button_text'     => esc_html__( 'Save Settings', 'wikilogy' ),
        'show_buttons'    => false,
        'sections'        => array(
          array(
            'id'          => 'create_setting',
            'title'       => esc_html__( 'Theme Options UI', 'wikilogy' )
          ),
          array(
            'id'          => 'import',
            'title'       => esc_html__( 'Import', 'wikilogy' )
          ),
          array(
            'id'          => 'export',
            'title'       => esc_html__( 'Export', 'wikilogy' )
          ),
          array(
            'id'          => 'layouts',
            'title'       => esc_html__( 'Layouts', 'wikilogy' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'theme_options_ui_text',
            'label'       => esc_html__( 'Theme Options UI Builder', 'wikilogy' ),
            'type'        => 'theme_options_ui',
            'section'     => 'create_setting'
          ),
          array(
            'id'          => 'import_xml_text',
            'label'       => esc_html__( 'Settings XML', 'wikilogy' ),
            'type'        => 'import-xml',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_settings_text',
            'label'       => esc_html__( 'Settings', 'wikilogy' ),
            'type'        => 'import-settings',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_data_text',
            'label'       => esc_html__( 'Theme Options', 'wikilogy' ),
            'type'        => 'import-data',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_layouts_text',
            'label'       => esc_html__( 'Layouts', 'wikilogy' ),
            'type'        => 'import-layouts',
            'section'     => 'import'
          ),
          array(
            'id'          => 'export_settings_file_text',
            'label'       => esc_html__( 'Settings PHP File', 'wikilogy' ),
          ...
          array(
            ...
            'label'       => esc_html__( 'Layout Management', 'wikilogy' ),
            'type'        => 'modify-layouts',
            'section'     => 'layouts'
          )
        )
      ...
      array(
        'id'              => 'documentation',
        'parent_slug'     => 'ot-settings',
        'page_title'      => esc_html__( 'Documentation', 'wikilogy' ),
        'menu_title'      => esc_html__( 'Documentation', 'wikilogy' ),
        'capability'      => 'edit_theme_options',
        ...
        'sections'        => array(
          array(
            'id'          => 'creating_options',
            'title'       => esc_html__( 'Creating Options', 'wikilogy' )
          ),
          array(
            'id'          => 'option_types',
            'title'       => esc_html__( 'Option Types', 'wikilogy' )
          ),
          array(
            'id'          => 'functions',
            'title'       => esc_html__( 'Function References', 'wikilogy' )
          ),
          array(
            'id'          => 'theme_mode',
            'title'       => esc_html__( 'Theme Mode', 'wikilogy' )
          ),
          array(
            'id'          => 'meta_boxes',
            'title'       => esc_html__( 'Meta Boxes', 'wikilogy' )
          ),
          array(
            'id'          => 'examples',
            'title'       => esc_html__( 'Code Examples', 'wikilogy' )
          ),
          array(
            'id'          => 'layouts_overview',
            'title'       => esc_html__( 'Layouts Overview', 'wikilogy' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'creating_options_text',
            'label'       => esc_html__( 'Overview of available Theme Option fields.', 'wikilogy' ),
            'type'        => 'creating-options',
            'section'     => 'creating_options'
          ),
          array(
            'id'          => 'option_types_text',
            'label'       => esc_html__( 'Option types in alphabetical order & hooks to filter them.', 'wikilogy' ),
            'type'        => 'option-types',
            'section'     => 'option_types'
          ),
          array(
            'id'          => 'functions_ot_get_option',
            'label'       => esc_html__( 'Function Reference:ot_get_option()', 'wikilogy' ),
            'type'        => 'ot-get-option',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'functions_get_option_tree',
            'label'       => esc_html__( 'Function Reference:get_option_tree()', 'wikilogy' ),
            'type'        => 'get-option-tree',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'theme_mode_text',
            'label'       => esc_html__( 'Theme Mode', 'wikilogy' ),
            'type'        => 'theme-mode',
            'section'     => 'theme_mode'
          ),
          array(
            'id'          => 'meta_boxes_text',
            'label'       => esc_html__( 'Meta Boxes', 'wikilogy' ),
            'type'        => 'meta-boxes',
            'section'     => 'meta_boxes'
          ),
          array(
            'id'          => 'example_text',
            'label'       => esc_html__( 'Code examples for front-end development.', 'wikilogy' ),
            'type'        => 'examples',
            'section'     => 'examples'
          ),
          array(
            'id'          => 'layouts_overview_text',
            'label'       => esc_html__( 'What\'s a layout anyhow?', 'wikilogy' ),
    ...
    if ( 'background' == $type ) {
      ...
      foreach( $input as $key => $value ) {
        ...
        if ( $key == 'width' && ! empty( $value ) && ! is_numeric( $value ) ) {
          ...
          add_settings_error( 'option-tree', 'invalid_border_width', sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'wikilogy' ), '<code>width</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( 0 === preg_match( '/^#([a-f0-9]{6}|[a-f0-9]{3})$/i', $input ) && 0 === preg_match( '/^rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]{1,4})\s*\)/i', $input ) ) {
        ...
        add_settings_error( 'option-tree', 'invalid_hex', sprintf( esc_html__( 'The %s Colorpicker only allows valid hexadecimal or rgba values.', 'wikilogy' ), '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'option-tree', 'invalid_dimension_' . $error, sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'wikilogy' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'option-tree', 'invalid_spacing_' . $error, sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'wikilogy' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    $localized_array = array( 
      ...
      'upload_text'           => apply_filters( 'ot_upload_text', esc_html__( 'Send to OptionTree', 'wikilogy' ) ),
      'remove_media_text'     => esc_html__( 'Remove Media', 'wikilogy' ),
      'reset_agree'           => esc_html__( 'Are you sure you want to reset back to the defaults?', 'wikilogy' ),
      'remove_no'             => esc_html__( 'You can\'t remove this! But you can edit the values.', 'wikilogy' ),
      'remove_agree'          => esc_html__( 'Are you sure you want to remove this?', 'wikilogy' ),
      'activate_layout_agree' => esc_html__( 'Are you sure you want to activate this layout?', 'wikilogy' ),
      'setting_limit'         => esc_html__( 'Sorry, you can\'t have settings three levels deep.', 'wikilogy' ),
      'delete'                => esc_html__( 'Delete Gallery', 'wikilogy' ), 
      'edit'                  => esc_html__( 'Edit Gallery', 'wikilogy' ), 
      'create'                => esc_html__( 'Create Gallery', 'wikilogy' ), 
      'confirm'               => esc_html__( 'Are you sure you want to delete this Gallery?', 'wikilogy' ),
      'date_current'          => esc_html__( 'Today', 'wikilogy' ),
      'date_time_current'     => esc_html__( 'Now', 'wikilogy' ),
      'date_close'            => esc_html__( 'Close', 'wikilogy' ),
      'replace'               => esc_html__( 'Featured Image', 'wikilogy' ),
      'with'                  => esc_html__( 'Image', 'wikilogy' )
    );
...
if ( ! function_exists( 'ot_create_media_post' ) ) {
  ...
  function ot_create_media_post() {
    ...
    $regsiter_post_type( 'option-tree', array(
      'labels'              => array( 'name' => esc_html__( 'Option Tree', 'wikilogy' ) ),
      'public'              => false,
      'show_ui'             => false,
      ...
      if ( ! isset( $settings['sections'] ) || ! isset( $settings['settings'] ) ) {
        ...
        $settings = array(
          'sections' => array(
            array(
              'id'        => 'general',
              'title'     => esc_html__( 'General', 'wikilogy' )
            )
          ),
          'settings' => array(
            array(
              'id'        => 'sample_text',
              'label'     => esc_html__( 'Sample Text Field Label', 'wikilogy' ),
              'desc'      => esc_html__( 'Description for the sample text field.', 'wikilogy' ),
              'section'   => 'general',
              'type'      => 'text',
              'std'       => '',
              'class'     => '',
  ...
  function ot_alert_message( $page = array() ) {
    ...
    if ( $action == 'save-settings' ) {
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Settings updated.', 'wikilogy' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Settings could not be saved.', 'wikilogy' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Settings Imported.', 'wikilogy' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Settings could not be imported.', 'wikilogy' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Data Imported.', 'wikilogy' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Data could not be imported.', 'wikilogy' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts Imported.', 'wikilogy' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Layouts could not be imported.', 'wikilogy' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts Updated.', 'wikilogy' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Layouts could not be updated.', 'wikilogy' ) . '</p></div>';
        
      } else if ( $message == 'deleted' ) {
        
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts have been deleted.', 'wikilogy' ) . '</p></div>';
        
      }
    
    } else if ( $updated == 'layout' ) {  
       
      return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layout activated.', 'wikilogy' ) . '</p></div>';
...
if ( ! function_exists( 'ot_option_types_array' ) ) {
  ...
  function ot_option_types_array() {
    ...
    return apply_filters( 'ot_option_types_array', array( 
      'background'                => esc_html__('Background', 'wikilogy'),
      'border'                    => esc_html__('Border', 'wikilogy'),
      'box-shadow'                => esc_html__('Box Shadow', 'wikilogy'),
      'category-checkbox'         => esc_html__('Category Checkbox', 'wikilogy'),
      'category-select'           => esc_html__('Category Select', 'wikilogy'),
      'checkbox'                  => esc_html__('Checkbox', 'wikilogy'),
      'colorpicker'               => esc_html__('Colorpicker', 'wikilogy'),
      'colorpicker-opacity'       => esc_html__('Colorpicker Opacity', 'wikilogy'),
      'css'                       => esc_html__('CSS', 'wikilogy'),
      'custom-post-type-checkbox' => esc_html__('Custom Post Type Checkbox', 'wikilogy'),
      'custom-post-type-select'   => esc_html__('Custom Post Type Select', 'wikilogy'),
      'date-picker'               => esc_html__('Date Picker', 'wikilogy'),
      'date-time-picker'          => esc_html__('Date Time Picker', 'wikilogy'),
      'dimension'                 => esc_html__('Dimension', 'wikilogy'),
      'gallery'                   => esc_html__('Gallery', 'wikilogy'),
      'google-fonts'              => esc_html__('Google Fonts', 'wikilogy'),
      'javascript'                => esc_html__('JavaScript', 'wikilogy'),
      'link-color'                => esc_html__('Link Color', 'wikilogy'),
      'list-item'                 => esc_html__('List Item', 'wikilogy'),
      'measurement'               => esc_html__('Measurement', 'wikilogy'),
      'numeric-slider'            => esc_html__('Numeric Slider', 'wikilogy'),
      'on-off'                    => esc_html__('On/Off', 'wikilogy'),
      'page-checkbox'             => esc_html__('Page Checkbox', 'wikilogy'),
      'page-select'               => esc_html__('Page Select', 'wikilogy'),
      'post-checkbox'             => esc_html__('Post Checkbox', 'wikilogy'),
      'post-select'               => esc_html__('Post Select', 'wikilogy'),
      'radio'                     => esc_html__('Radio', 'wikilogy'),
      'radio-image'               => esc_html__('Radio Image', 'wikilogy'),
      'select'                    => esc_html__('Select', 'wikilogy'),
      'sidebar-select'            => esc_html__('Sidebar Select',  'wikilogy'),
      'slider'                    => esc_html__('Slider', 'wikilogy'),
      'social-links'              => esc_html__('Social Links', 'wikilogy'),
      'spacing'                   => esc_html__('Spacing', 'wikilogy'),
      'tab'                       => esc_html__('Tab', 'wikilogy'),
      'tag-checkbox'              => esc_html__('Tag Checkbox', 'wikilogy'),
      'tag-select'                => esc_html__('Tag Select', 'wikilogy'),
      'taxonomy-checkbox'         => esc_html__('Taxonomy Checkbox', 'wikilogy'),
      'taxonomy-select'           => esc_html__('Taxonomy Select', 'wikilogy'),
      'text'                      => esc_html__('Text', 'wikilogy'),
      'textarea'                  => esc_html__('Textarea', 'wikilogy'),
      'textarea-simple'           => esc_html__('Textarea Simple', 'wikilogy'),
      'textblock'                 => esc_html__('Textblock', 'wikilogy'),
      'textblock-titled'          => esc_html__('Textblock Titled', 'wikilogy'),
      'typography'                => esc_html__('Typography', 'wikilogy'),
      'upload'                    => esc_html__('Upload', 'wikilogy')
    ) );
...
if ( ! function_exists( 'ot_radio_images' ) ) {
  ...
  function ot_radio_images( $field_id = '' ) {
    ...
    return apply_filters( 'ot_radio_images', array(
      ...
      array(
        'value'   => 'full-width',
        'label'   => esc_html__( 'Full Width (no sidebar)', 'wikilogy' ),
...
if ( ! function_exists( 'ot_social_links_settings' ) ) {
  ...
  function ot_social_links_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_social_links_settings', array(
      array(
        'id'        => 'name',
        'label'     => esc_html__( 'Name', 'wikilogy' ),
        'desc'      => esc_html__( 'Enter the name of the social website.', 'wikilogy' ),
        'std'       => '',
        'type'      => 'text',
      ...
      array(
        'id'        => 'title',
        'label'     => 'Title',
        'desc'      => esc_html__( 'Enter the text shown in the title attribute of the link.', 'wikilogy' ),
        'type'      => 'text'
      ),
      array(
        'id'        => 'href',
        'label'     => 'Link',
        'desc'      => sprintf( esc_html__( 'Enter a link to the profile or page on the social website. Remember to add the %s part to the front of the link.', 'wikilogy' ), '<code>http://</code>' ),
        'type'      => 'text',
      )
    ), $id );
  ...
  function ot_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
    ...
    if ( file_exists( $filepath ) ) {
      ...
      if ( ! is_writable( $filepath ) ) {
        add_settings_error( 'option-tree', 'dynamic_css', sprintf( esc_html__( 'Unable to write to file %s.', 'wikilogy' ), '<code>' . $filepath . '</code>' ), 'error' );
        return false;
      }
  ...
  function ot_sections_view( $name, $key, $section = array() ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . esc_html__( 'edit', 'wikilogy' ) . '">
          <span class="icon ot-icon-pencil"></span>' . esc_html__( 'Edit', 'wikilogy' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . esc_html__( 'Delete', 'wikilogy' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . esc_html__( 'Delete', 'wikilogy' ) . '
        </a>
      </div>
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . esc_html__( '<strong>Section Title</strong>: Displayed as a menu item on the Theme Options page.', 'wikilogy' ) . '</div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . esc_html__( '<strong>Section ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>Label</strong>: Displayed as the label of a form element on the Theme Options page.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . esc_html__( '<strong>Type</strong>: Choose one of the available option types from the dropdown.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea wide-desc">
            <div class="description">' . esc_html__( '<strong>Description</strong>: Enter a detailed description for the users to read on the Theme Options page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . esc_html__( '<strong>Choices</strong>: This will only affect the following option types: Checkbox, Radio, Select & Select Image.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-choice-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Choice', 'wikilogy' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . esc_html__( '<strong>Settings</strong>: This will only affect the List Item option type.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
              <ul class="option-tree-setting-wrap option-tree-sortable" data-name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . ']">
                ' . ( isset( $setting['settings'] ) ? ot_loop_through_sub_settings( $name . '[' . $key . '][settings]', $setting['settings'] ) : '' ) . '
              </ul>
              <a href="javascript:void(0);" class="option-tree-list-item-setting-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Setting', 'wikilogy' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>Standard</strong>: Setting the standard value for your option only works for some option types. Read the <code>OptionTree->Documentation</code> for more information on which ones.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
              ' . $std_form_element . '
            </div>
          </div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>Rows</strong>: Enter a numeric value for the number of rows in your textarea. This will only affect the following option types: CSS, Textarea, & Textarea Simple.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>Post Type</strong>: Add a comma separated list of post type like \'post,page\'. This will only affect the following option types: Custom Post Type Checkbox, & Custom Post Type Select.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>Taxonomy</strong>: Add a comma separated list of any registered taxonomy like \'category,post_tag\'. This will only affect the following option types: Taxonomy Checkbox, & Taxonomy Select.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>Min, Max, & Step</strong>: Add a comma separated list of options in the following format <code>0,100,1</code> (slide from <code>0-100</code> in intervals of <code>1</code>). The three values represent the minimum, maximum, and step options and will only affect the Numeric Slider option type.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>CSS Class</strong>: Add and optional class to this option type.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . esc_html__( '<strong>Operator</strong>: Choose the logical operator to compute the result of the conditions.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
              <select name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][operator]" value="' . $operator . '" class="option-tree-ui-select">
                <option value="and" ' . selected( $operator, 'and', false ) . '>' . esc_html__( 'and', 'wikilogy' ) . '</option>
                <option value="or" ' . selected( $operator, 'or', false ) . '>' . esc_html__( 'or', 'wikilogy' ) . '</option>
              </select>
            </div>
          </div>
        </div>
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . esc_html__( 'Label', 'wikilogy' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . esc_html__( 'Value', 'wikilogy' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . esc_html__( 'Image Source (Radio Image only)', 'wikilogy' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text no-desc">
            <div class="description">' . esc_html__( '<strong>Title</strong>: Displayed as a contextual help menu item on the Theme Options page.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea no-desc">
            <div class="description">' . esc_html__( '<strong>Content</strong>: Enter the HTML content about this contextual help item displayed on the Theme Option page for end users to read.', 'wikilogy' ) . '</div>
            <div class="format-setting-inner">
...
if ( ! function_exists( 'ot_layout_view' ) ) {
  ...
  function ot_layout_view( $key, $data = '', $active_layout = '' ) {
    ...
    return '
    <div class="option-tree-setting">
      <div class="open">' . ( isset( $key ) ? esc_attr( $key ) : esc_html__( 'Layout', 'wikilogy' ) ) . '</div>
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout == $key ? ' active' : '' ) . '" title="' . esc_html__( 'Activate', 'wikilogy' ) . '">
          <span class="icon ot-icon-square-o"></span>' . esc_html__( 'Activate', 'wikilogy' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="'. esc_html__( 'Delete', 'wikilogy' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . esc_html__( 'Delete', 'wikilogy' ) . '
        </a>
...
if ( ! function_exists( 'ot_list_item_view' ) ) {
  ...
  function ot_list_item_view( $name, $key, $list_item = array(), $post_id = 0, $get_option = '', $settings = array(), $type = '' ) {
    ...
    $required_setting = array(
      array(
        'id'        => 'title',
        'label'     => esc_html__( 'Title', 'wikilogy' ),
        'desc'      => '',
        'std'       => '',
        'type'      => 'text',
        'rows'      => '',
  ...
  function ot_theme_options_layouts_form( $active = false ) {
    ...
    echo '<form method="post" id="option-tree-options-layouts-form">';
      ...
      echo '<div class="option-tree-save-layout' . ( ! empty( $active_layout ) ? ' active-layout' : '' ) . '">';
        ...
        echo '<button type="submit" class="option-tree-ui-button button button-primary save-layout" title="' . esc_html__( 'New Layout', 'wikilogy' ) . '">' . esc_html__( 'New Layout', 'wikilogy' ) . '</button>';
...
function ot_meta_box_post_format_gallery( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_gallery', array(
    ...
    'title'     => esc_html__( 'Gallery', 'wikilogy' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
...
function ot_meta_box_post_format_link( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_link', array(
    ...
    'title'     => esc_html__( 'Link', 'wikilogy' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
    'fields'    => array(
      array(
        'id'      => '_format_link_url',
        'label'   => '',
        'desc'    => esc_html__( 'Link URL', 'wikilogy' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Link Title', 'wikilogy' ),
        'std'     => '',
        'type'    => 'text'
      )
  	)
...
function ot_meta_box_post_format_quote( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_quote', array(
    ...
    'title'     => esc_html__( 'Quote', 'wikilogy' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Name (ex. author, singer, actor)', 'wikilogy' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source URL', 'wikilogy' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Title (ex. book, song, movie)', 'wikilogy' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Date', 'wikilogy' ),
        'std'     => '',
        'type'    => 'text'
      )
  	)
...
function ot_meta_box_post_format_video( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_video', array(
    ...
    'title'     => esc_html__( 'Video', 'wikilogy' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => sprintf( esc_html__( 'Embed video from services like Youtube, Vimeo, or Hulu. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'wikilogy' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . esc_html__( 'Wordpress Codex', 'wikilogy' ) .'</a>', '<code>[video]</code>' ),
        'std'     => '',
        'type'    => 'textarea'
      )
  	)
...
function ot_meta_box_post_format_audio( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_audio', array(
    ...
    'title'     => esc_html__( 'Audio', 'wikilogy' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
