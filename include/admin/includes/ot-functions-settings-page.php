    ...
    echo '<form method="post" id="option-tree-settings-form">';
      ...
      echo '<div class="format-setting type-textblock has-desc">';
        ...
        echo '<div class="description">';
          ...
          echo '<h4>'. esc_html__( 'Warning!', 'wikilogy' ) . '</h4>';
          echo '<p class="warning">' . sprintf( esc_html__( 'Go to the %s page if you want to save data, this page is for adding settings.', 'wikilogy' ), '<a href="' . get_admin_url( $blog_id, apply_filters( 'ot_theme_options_parent_slug', 'themes.php' ) . '?page=' . apply_filters( 'ot_theme_options_menu_slug', 'ot-theme-options' ) ) . '"><code>Appearance->Theme Options</code></a>' ) . '</p>';
          echo '<p class="warning">' . sprintf( esc_html__( 'If you\'re unsure or not completely positive that you should be editing these settings, you should read the %s first.', 'wikilogy' ), '<a href="' . get_admin_url( $blog_id, 'admin.php?page=ot-documentation' ) . '"><code>OptionTree->Documentation</code></a>' ) . '</p>';
          echo '<h4>'. esc_html__( 'Things could break or be improperly displayed to the end-user if you do one of the following:', 'wikilogy' ) . '</h4>';
          echo '<p class="warning">' . esc_html__( 'Give two sections the same ID, give two settings the same ID, give two contextual help content areas the same ID, don\'t create any settings, or have a section at the end of the settings list.', 'wikilogy' ) . '</p>';
          echo '<p>' . esc_html__( 'You can create as many settings as your project requires and use them how you see fit. When you add a setting here, it will be available on the Theme Options page for use in your theme. To separate your settings into sections, click the "Add Section" button, fill in the input fields, and a new navigation menu item will be created.', 'wikilogy' ) . '</p>';
          echo '<p>' . esc_html__( 'All of the settings can be sorted and rearranged to your liking with Drag & Drop. Don\'t worry about the order in which you create your settings, you can always reorder them.', 'wikilogy' ) . '</p>';
        ...
        echo '<div class="format-setting-inner">';
          ...
          /* buttons */
          echo '<a href="javascript:void(0);" class="option-tree-section-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Section', 'wikilogy' ) . '</a>';
          echo '<a href="javascript:void(0);" class="option-tree-setting-add option-tree-ui-button button">' . esc_html__( 'Add Setting', 'wikilogy' ) . '</a>';
          echo '<button class="option-tree-ui-button button button-primary right hug-right">' . esc_html__( 'Save Changes', 'wikilogy' ) . '</button>';
          
          /* sidebar textarea */
          echo '
          <div class="format-setting-label" id="contextual-help-label">
            <h3 class="label">' . esc_html__( 'Contextual Help', 'wikilogy' ) . '</h3>
          </div>
          <div class="format-settings" id="contextual-help-setting">
            <div class="format-setting type-textarea no-desc">
              <div class="description"><strong>' . esc_html__( 'Contextual Help Sidebar', 'wikilogy' ) . '</strong>: ' . esc_html__( 'If you decide to add contextual help to the Theme Option page, enter the optional "Sidebar" HTML here. This would be an extremely useful place to add links to your themes documentation or support forum. Only after you\'ve added some content below will this display to the user.', 'wikilogy' ) . '</div>
          ...
          echo '<a href="javascript:void(0);" class="option-tree-help-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Contextual Help Content', 'wikilogy' ) . '</a>';
          echo '<button class="option-tree-ui-button button button-primary right hug-right">' . esc_html__( 'Save Changes', 'wikilogy' ) . '</button>';
    ...
    echo '<form method="post" id="import-xml-form">';
      ...
      echo '<div class="format-setting type-textblock has-desc">';
        ...
        echo '<div class="description">';
          ...
          echo '<p class="deprecated">' . esc_html__( 'This import method has been deprecated. That means it has been replaced by a new method and is no longer supported, and may be removed from future versions. All themes that use this import method should be converted to use its replacement below.', 'wikilogy' ) . '</p>';
          
          echo '<p>' . sprintf( esc_html__( 'If you were given a Theme Options XML file with a premium or free theme, locate it on your hard drive and upload that file by clicking the upload button. A popup window will appear, upload the XML file and click "%s". The file URL should be in the upload input, if it is click "Import XML".', 'wikilogy' ), apply_filters( 'ot_upload_text', esc_html__( 'Send to OptionTree', 'wikilogy' ) ) ) . '</p>';
          
          /* button */
          echo '<button class="option-tree-ui-button button button-primary right hug-right">' . esc_html__( 'Import XML', 'wikilogy' ) . '</button>';
        ...
        echo '<div class="format-setting-inner">';
          ...
          echo '<div class="option-tree-ui-upload-parent">';
            ...
            /* add xml button */
            echo '<a href="javascript:void(0);" class="ot_upload_media option-tree-ui-button button button-primary light" rel="' . $post_id . '" title="' . esc_html__( 'Add XML', 'wikilogy' ) . '"><span class="icon ot-icon-plus-circle"></span>' . esc_html__( 'Add XML', 'wikilogy' ) . '</a>';
    ...
    echo '<form method="post" id="import-settings-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="description">';
          ...
          echo '<p>' . esc_html__( 'To import your Settings copy and paste what appears to be a random string of alpha numeric characters into this textarea and press the "Import Settings" button.', 'wikilogy' ) . '</p>';
          
          /* button */
          echo '<button class="option-tree-ui-button button button-primary right hug-right">' . esc_html__( 'Import Settings', 'wikilogy' ) . '</button>';
    ...
    echo '<form method="post" id="import-data-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="description">';
          ...
          if ( OT_SHOW_SETTINGS_IMPORT ) echo '<p>' . esc_html__( 'Only after you\'ve imported the Settings should you try and update your Theme Options.', 'wikilogy' ) . '</p>';
          
          echo '<p>' . esc_html__( 'To import your Theme Options copy and paste what appears to be a random string of alpha numeric characters into this textarea and press the "Import Theme Options" button.', 'wikilogy' ) . '</p>';
          
          /* button */
          echo '<button class="option-tree-ui-button button button-primary right hug-right">' . esc_html__( 'Import Theme Options', 'wikilogy' ) . '</button>';
    ...
    echo '<form method="post" id="import-layouts-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="description">';
          ...
          if ( OT_SHOW_SETTINGS_IMPORT ) echo '<p>' . esc_html__( 'Only after you\'ve imported the Settings should you try and update your Layouts.', 'wikilogy' ) . '</p>';
          
          echo '<p>' . esc_html__( 'To import your Layouts copy and paste what appears to be a random string of alpha numeric characters into this textarea and press the "Import Layouts" button. Keep in mind that when you import your layouts, the active layout\'s saved data will write over the current data set for your Theme Options.', 'wikilogy' ) . '</p>';
          
          /* button */
          echo '<button class="option-tree-ui-button button button-primary right hug-right">' . esc_html__( 'Import Layouts', 'wikilogy' ) . '</button>';
    ...
    echo '<form method="post" id="export-settings-file-form">';
      ...
      echo '<div class="format-setting type-textarea simple has-desc">';
        ...
        echo '<div class="description">';
          ...
          echo '<p>' . sprintf( esc_html__( 'Export your Settings into a fully functional %s file. If you want to add your own custom %s text domain to the file, enter it into the text field before exporting. For more information on how to use this file read the documentation on %s. Remember, you should always check the file for errors before including it in your theme.', 'wikilogy' ), '<code>theme-options.php</code>', '<a href="http://codex.wordpress.org/I18n_for_WordPress_Developers" target="_blank">I18n</a>', '<a href="' . get_admin_url( $blog_id, 'admin.php?page=ot-documentation#section_theme_mode' ) . '">' . esc_html__( 'Theme Mode', 'wikilogy' ) . '</a>' ) . '</p>';
        ...
        echo '<div class="format-setting-inner">';
          ...
          /* button */
          echo '<button class="option-tree-ui-button button button-primary hug-left">' . esc_html__( 'Export Settings File', 'wikilogy' ) . '</button>';
    ...
    echo '<form method="post" id="option-tree-settings-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="description">';
          ...
          echo '<p>' . esc_html__( 'To add a new layout enter a unique lower case alphanumeric string (dashes allowed) in the text field and click "Save Layouts".', 'wikilogy' ) . '</p>';
          echo '<p>' . esc_html__( 'As well, you can activate, remove, and drag & drop the order; all situations require you to click "Save Layouts" for the changes to be applied.', 'wikilogy' ) . '</p>';
          echo '<p>' . esc_html__( 'When you create a new layout it will become active and any changes made to the Theme Options will be applied to it. If you switch back to a different layout immediately after creating a new layout that new layout will have a snapshot of the current Theme Options data attached to it.', 'wikilogy' ) . '</p>';
          if ( OT_SHOW_DOCS ) echo '<p>' . esc_html__( 'Visit <code>OptionTree->Documentation->Layouts Overview</code> to see a more in-depth description of what layouts are and how to use them.', 'wikilogy' ) . '</p>';
        ...
        echo '<div class="format-setting-inner">';
          ...
          echo '<button class="option-tree-ui-button button button-primary right hug-right">' . esc_html__( 'Save Layouts', 'wikilogy' ) . '</button>';
